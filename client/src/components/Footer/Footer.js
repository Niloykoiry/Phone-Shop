            ...
            <div className="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
              ...
              <ul>
                ...
                <li className="mb-3">
                  ...
                  <Link to="/">+8801515608951</Link>{" "}
                </li>
                <li className="mb-3">
                  <i className="fas fa-phone"></i>
                  <Link to="/">+8801670821404</Link>{" "}
                </li>
                <li className="mb-3">
                  <i className="fas fa-envelope-open"></i>
                  <Link to="/">koiry.niloy@gmail.com</Link>
                </li>
                <li>
                  <i className="fas fa-envelope-open"></i>
                  <Link to="/"> koiry.niloy@gmail.com</Link>
      ...
      <div className="copy-right py-3">
        <div className="container">
          <p className="text-center ">
            © 2022 <span className="logoName">Phone Shop</span>. All rights
            reserved | Designed by
            <span> Niloy Koiry</span>
          </p>
        </div>
      </div>
    </>
